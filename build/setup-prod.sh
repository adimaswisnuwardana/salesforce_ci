...
echo "Authenticating..."
sfdx force:auth:jwt:grant --clientid $SFDC_PROD_CLIENTID --jwtkeyfile /server.key --username $SFDC_PROD_USER --instanceurl https://login.salesforce.com --setdefaultdevhubusername -a DevHub
